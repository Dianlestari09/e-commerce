-- ============================================================
-- MIGRATION: Add related_article_ids for Inlink/Baca Juga & Re-insert 6 dummy articles
-- ============================================================

-- 1. Add related_article_ids column if not exists
ALTER TABLE public.articles 
ADD COLUMN IF NOT EXISTS related_article_ids uuid[] DEFAULT '{}';

-- Set default author_name for future inserts
ALTER TABLE public.articles
ALTER COLUMN author_name SET DEFAULT 'Dian Lestari Kurniawati';

-- 2. Clear old dummy articles to avoid slug / constraint conflicts
DELETE FROM public.articles;

-- 3. Insert 6 sample articles with static UUIDs and related links
INSERT INTO public.articles (
  id, title, slug, excerpt, content, cover_image, author_name, category, tags,
  status, meta_title, meta_description, schema_code, related_article_ids, published_at
) VALUES
...
<p>Memilih produk rumah tangga yang tepat memerlukan pertimbangan yang matang. Dengan mengikuti 10 tips di atas, Anda bisa mendapatkan produk yang tidak hanya sesuai budget namun juga memberikan value terbaik untuk keluarga Anda.</p>',
  ...
  'Panduan lengkap memilih produk rumah tangga yang tahan lama, efisien, dan sesuai kebutuhan keluarga tanpa menguras kantong. Tips dari Dian Lestari Kurniawati.',
  '{
  ...
  "author": {"@type": "Person", "name": "Dian Lestari Kurniawati"},
  "publisher": {"@type": "Organization", "name": "ShopWise", "logo": {"@type": "ImageObject", "url": "/shop/assets/img/favicon.png"}},
  "datePublished": "2026-07-01",
  "image": "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=1200&q=80"
}',
  ARRAY['a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a13'::uuid, 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a15'::uuid],
...
<p>Dunia teknologi 2026 menawarkan banyak pilihan menarik. Sesuaikan pilihan dengan kebutuhan dan budget Anda. ShopWise hadir untuk membantu Anda menemukan produk teknologi terbaik dengan harga yang kompetitif.</p>',
  ...
  'Daftar gadget dan produk teknologi 2026 yang wajib dimiliki, dari smartwatch canggih hingga laptop AI. Review lengkap dari Dian Lestari Kurniawati.',
  '{
  "@context": "https://schema.org",
  "@type": "Article",
  "headline": "Tren Produk Teknologi Terpopuler 2026 yang Wajib Kamu Punya",
  "description": "Daftar gadget & produk teknologi 2026 yang sedang ramai diperbincangkan.",
  "author": {"@type": "Person", "name": "Dian Lestari Kurniawati"},
  "publisher": {"@type": "Organization", "name": "ShopWise"},
  "datePublished": "2026-07-03"
}',
  ARRAY['a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a14'::uuid],
...
<li>Pastikan semua peralatan benar-benar kering sebelum disimpan</li>
  ...
  'Cara merawat pisau, wajan, dan peralatan dapur lainnya agar awet bertahun-tahun. Panduan lengkap dari Dian Lestari Kurniawati.',
  '{
  "@context": "https://schema.org",
  "@type": "Article",
  "headline": "Panduan Lengkap Merawat Peralatan Dapur agar Tahan Lama",
  "description": "Peralatan dapur yang dirawat dengan benar bisa bertahan puluhan tahun.",
  "author": {"@type": "Person", "name": "Dian Lestari Kurniawati"},
  "publisher": {"@type": "Organization", "name": "ShopWise"},
  "datePublished": "2026-07-05"
}',
  ARRAY['a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11'::uuid, 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a15'::uuid],
  NOW() - INTERVAL '9 days'
),
...
<p>Pilihan terbaik tergantung ekosistem yang Anda gunakan. Jika Anda pengguna Android, Echo Studio atau Google Nest Audio Pro adalah pilihan utama. Pengguna Apple wajib mempertimbangkan HomePod. Untuk budget terbatas, Xiaomi Sound Pro adalah jawabannya.</p>',
  ...
  'Review jujur 5 smart speaker terpopuler 2026. Review oleh Dian Lestari Kurniawati.',
  '{
  "@context": "https://schema.org",
  "@type": "Review",
  ...
  ARRAY['a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12'::uuid],
  NOW() - INTERVAL '7 days'
),
...
<p>Belanja online kini telah menjadi gaya hidup bagi jon jutaan orang Indonesia. Kemudahan dan variasi produk yang tersedia membuatnya sangat menggiurkan, namun tantangannya adalah memastikan keamanan dan mendapatkan value terbaik dari setiap transaksi.</p>
...
<p>Jika Anda merasa ditipu, segera hubungi customer service marketplace, laporkan ke Kominfo melalui aduankonten.id, dan jika nominal cukup besar, lapor ke kepolisian dengan membawa bukti transaksi lengkap.</p>',
  ...
  'Strategi jitu berbelanja online dengan aman, mengenali tanda-tanda penipuan, dan cara mendapatkan harga terbaik dari Dian Lestari Kurniawati.',
  '{
  "@context": "https://schema.org",
  "@type": "Article",
  "headline": "Cara Cerdas Berbelanja Online: Hindari Penipuan dan Dapatkan Harga Terbaik",
  "description": "Strategi jitu berbelanja online dengan aman dan mendapatkan harga terbaik.",
  "author": {"@type": "Person", "name": "Dian Lestari Kurniawati"},
  "publisher": {"@type": "Organization", "name": "ShopWise"},
...
<p>ShopWise menghadirkan koleksi dekorasi rumah pilihan yang selaras dengan tren minimalis modern 2026. Dari pot tanaman geometris, lampu meja industrial, hingga wall art minimalis — semua tersedia dengan harga yang terjangkau.</p>',
  ...
  'Inspirasi dekorasi rumah minimalis modern untuk 2026. Ditulis oleh Dian Lestari Kurniawati.',
  '{
  "@context": "https://schema.org",
  "@type": "Article",
